...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x173256; // address starts with "cwis"
...
const char     CRYPTONOTE_NAME[]                             = "wiscoin";
...
const int      P2P_DEFAULT_PORT                              = 47427;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 38129;
